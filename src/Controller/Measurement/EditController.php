...
final class EditController extends AbstractController
{
    ...
    #[Route(path: '/measurements/body/{id?}', name: 'app_measurement_edit', methods: ['GET', 'POST'])]
    ...
    public function __invoke(
        ...
        $form = $this->createForm(EditMeasurementType::class, null, [
            'lastMeasurement' => $measurement === null ? $this->measurementService->getLastMeasurement() : null,
