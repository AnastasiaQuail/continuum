...
final class Version20260113021856 extends AbstractMigration
{
    #[Override]
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_WEEKLY_REFLECTIONS_DATE ON weekly_reflections (date)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE weekly_reflections');
    }
}
