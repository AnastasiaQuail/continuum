    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              workout_exercises
            ADD
              CONSTRAINT FK_2D7B2EC5A6CCCFC9 FOREIGN KEY (workout_id) REFERENCES workouts (id) NOT DEFERRABLE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              workout_exercises
            ADD
              CONSTRAINT FK_2D7B2EC5E934951A FOREIGN KEY (exercise_id) REFERENCES exercises (id) NOT DEFERRABLE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              workout_sets
            ADD
              CONSTRAINT FK_EC0346ADE435DB6B FOREIGN KEY (workout_exercise_id) REFERENCES workout_exercises (id) NOT DEFERRABLE
        SQL);
    }
